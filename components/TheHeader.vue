...
<template>
  <header
    class="fixed inset-x-0 top-0 left-0 z-30 border-b-2 border-orange-500 bg-white bg-gradient-to-r from-[#6EE7B7] via-[#3B82F6] to-[#9333EA] p-[6px] px-6 py-4 shadow-xl"
  >
    <div class="container mx-auto flex items-center justify-between">
      <div class="flex items-center">
        <NuxtLink
          :to="{ name: 'index' }"
          class="space-x-2 rounded-full bg-white px-2 py-1 text-xl font-bold hover:shadow-xl sm:px-4 sm:py-2"
        >
          <font-awesome-icon
            icon="biohazard"
      ...
      <div class="flex items-center space-x-10">
        <div class="relative">
          <button type="button" @click="toggleDialog" class="flex items-center">
